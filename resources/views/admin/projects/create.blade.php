<x-admin-layout>
    ...
    <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" rows="6" required>{{ old('description') }}</textarea>
    ...
    @enderror
            ...
            <div class="mb-4">
                ...
                <input type="file" id="image" name="image"
                     class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white" required>
                @error('image')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
