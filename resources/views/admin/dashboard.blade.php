        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                ...
                                @if(session('login_success'))
                                    <div id="admin-login-alert" class="p-4 text-xs md:text-sm font-normal text-center text-white transition-opacity opacity-0" style="background:inherit;">
                                        {{ __("You're logged in as admin!") }}
                                    </div>
                                    <script>
                                    // Tailwind fade-in dan hilangkan seluruh elemen
                                    document.addEventListener('DOMContentLoaded', function() {
                                        const alert = document.getElementById('admin-login-alert');
                                        if(alert) {
        ...
        <div class="flex flex-wrap -mx-6">
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ $projects }}</h4>
